...
public class SlopeOne extends AppCompatActivity {
    ...
    private static ItemId[] mAllItems;
    ...
    protected final void onCreate(Bundle savedInstanceState) {
        ...
        mapeamento(data, item1, item2, item3, item4, item5, user1, user2, user3, user4);

    }

    private void mapeamento(Map<UserId, Map<ItemId, Float>> data, ItemId item1, ItemId item2, ItemId item3, ItemId item4, ItemId item5, HashMap<ItemId, Float> user1, HashMap<ItemId, Float> user2, HashMap<ItemId, Float> user3, HashMap<ItemId, Float> user4) {
    ...
    public void buildDiffMatrix(Map<UserId,Map<ItemId,Float>> data) {
        ...
        for (Map<ItemId, Float> user : data.values()) {
